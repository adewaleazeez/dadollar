...
<html>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#showPrompt").dialog({
                    ...
                    buttons: {
                        Ok: function() {
							...
							createCookie('thisuser', null, false);
							logoutUser();
                        }
                    }
                });
				...
				if(navigator.appName == "Microsoft Internet Explorer"){
					$('#changepass').dialog({ modal: false, height: 380, width: 450 });
				}				

            });
			createCookie('progid', 'changePass', false);
        </script>
    </head>
    <body class="cbp-spmenu-push" style="background-color: #6633FF; font-color: #FFFFFF;"><!--#1abc9c;-->
		...
		<div style="height:335px; width:415px; top:5px; left:10px" id="changepass">
			<table style="width:380px">
				<tr class="formLabel">
					<td><b>User&nbsp;Name:</b></td>
					<!-- UserName -->
					<td class="input">
						<input type="text" id="username2" size="30" tabindex="1" readonly disabled='true' />
					</td>
				</tr>
				</tr><td>&nbsp;</td></tr>
				<tr class="formLabel">
					...
					<!-- Password -->
					<td class="input">
						<input type="password" id="password" size="20" maxlength=20  tabindex="2" />
					</td>
				</tr>
				<tr class="formLabel">
					...
					<!-- Password -->
					<td class="input">
						<input type="password" id="newpassword" size="20" maxlength=20  tabindex="3" />
					</td>
				</tr>
				<tr class="formLabel">
					...
					<!-- Password -->
					<td class="input">
						<input type="password" id="rptpassword" onkeypress="checkEnter(event)" size="20" maxlength=20  tabindex="4" />
					</td>
				</tr>
			</table>
		</div>
...
<script>
	document.getElementById("username2").value=readCookie('thisuser');
</script>