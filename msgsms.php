                ...
                /*$("#balances").dialog({
                    ...
                    buttons: {
                        Send_SMS: function () {
							...
							setTimeout(function(){ alert("Timeout"); }, 7000);
							var selectedids = "";
							selectedIdsArray = [];
                            for (k = 0; k < totalrecords; k++) {
                                var selectid = "box" + k;
                                var serial_no = "hidden" + k;
                                if (document.getElementById(selectid).checked === true &&  document.getElementById(serial_no).value!=="") {
									selectedIdsArray.push(document.getElementById(serial_no).value);
                                    if (selectedids !== "") {
                                        selectedids += "_~_";
                                    }
                                    selectedids += document.getElementById(serial_no).value;
                                }
                            }
                            ...
                            if (textmsg==""){
                                error += "SMS message must not be blank.<br><br>";
                            }
                            if (selectedids==""){
                            ...
                            var url = "/dadollar/sendbulksms.php?option=smsmsg&textmsg="+textmsg; //option=smstranslist&
...
//                            }
            ...
            function sendSMS(){
				...
				selectedIdsArray = [];
				if(totalrecords > 0){
					for (k = processedIds; k < totalrecords; k++) {
						var selectid = "box" + k;
						var serial_no = "hidden" + k;
						if (document.getElementById(selectid).checked === true &&  document.getElementById(serial_no).value!=="") {
							selectedIdsArray.push(document.getElementById(serial_no).value);
				...
				if (textmsg===undefined || textmsg===""){
					error += "SMS message must not be blank.<br><br>";
				}
				if (selectedIdsArray.length===0){
					error += "Finished processing all customers or <BR>No Customer is selected for SMS message.<br><br>";
				}
				if (error.length > 0) {
					error = "<br><b>Please correct the following errors:</b> <br><br><br>" + error;
					document.getElementById("showError").innerHTML = error;
...
//									document.getElementById("balance_aid"+id2[1]).value="";
    ...
    <body>
        ...
        <div id="balances">
            <div style='border:5px solid #ddd;color:#000000; width:1310px; height:590px; overflow:auto;'>
                <table style='font-size:14px;'>
                    <tr>
                        <td align='right' style="color: red"><b>Line&nbsp;No:&nbsp;</b></td>
                        
                        <td>
                            <input type="text" id="lineno" style="display:inline" size="20" onkeyup="getRecordlist(this.id, 'lineno', 'recordlist');
                                   " onclick="this.value = ''; getRecordlist(this.id, 'lineno', 'recordlist');" onkeydown="checkKeyPressed(event, this.id);" />
                            &nbsp;&nbsp;
                            <input type="button" style="display:inline" value=" List Customers " id="listtrans" onclick="listCustomers();" onkeydown="checkKeyPressed(event, this.id);" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6">
                            <div id="custlist" style="width:1280px; height:400px; overflow:auto;"></div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6">
							<br>
                            <div id="msgbox" style="width:1280px; height:90px; overflow:auto;"></div>
                            <table><tr><td>Character/SMS: 160&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>Character used:&nbsp;</td><td id="char_used"></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Average No of SMS Used:&nbsp;</td><td id="sms_used"></td></tr></table>
                        </td>
                    </tr>
                </table>
