        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#balances").dialog({
                    autoOpen: true,
                    position:[280,70],
                    title: 'Customers Transaction Listing Report',
                    height: 620,
                    width: 1350,
                    modal: false,
                    buttons: {
			...
			<div style='border:5px solid #ddd;color:#000000;'>
				<table style='font-size:14px;'>
					<tr>
						...
						<td>
							<input type="text" id="username" style="display:inline" size="20" onkeyup="getRecordlist(this.id, 'users', 'recordlist'); " onclick="this.value=''; getRecordlist(this.id, 'users', 'recordlist');" onkeydown="checkKeyPressed(event,this.id);" />
							&nbsp;&nbsp;
							<input type="button" style="display:inline" value=" List Transactions " id="listtrans" onclick="listTransaction();" onkeydown="checkKeyPressed(event,this.id);" />
							&nbsp;&nbsp;
							<input type="button" style="display:inline" value=" Show Customer Statements " id="listtrans" onclick="showStatements()" onkeydown="checkKeyPressed(event,this.id);" />
						</td>
					</tr>
					<tr>
						<td colspan="6">
		...
		<div id="transactioninfo">
				...
				<table style='font-size:14px;'>
					<tr>
						...
						<td>
							...
							<input style="display:inline" type='text' id='names' readonly disabled="true" size='30' />&nbsp;&nbsp;
						</td>
						<td rowspan="6">
					...
					<tr>
						...
						<td>
							<input type='text' id='statementdate' name='statementdate' size='11' onclick="this.value=''; clearLists('recordlist'); getDate('statementdate')" style="display:inline; " onkeydown="checkKeyPressed2(event,this.id);" />
						</td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td align='right' style="color: red"><b>Credit:&nbsp;</b></td>
						<td>
					...
					<tr>
						<td align='right' style="color: red"><b>Debit:&nbsp;</b></td>
						<td>
					...
					<tr>
						<td align='right' style="color: red"><b>Balance:&nbsp;</b></td>
						<td>
							<input type="text" id="balance" size="15" style="display:inline; text-align:right;" readonly disabled="true" />
						</td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td align='right' style=" color: red"><b>Trans.&nbsp;Type:&nbsp;</b></td>
						<td>
							<input style="display:inline" type='text' id='transtype' size='20' readonly disabled="true" />
						</td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td align='right' style=" color: red"><b>User Name:&nbsp;</b></td>
						<td>
							<input style="display:inline" type='text' id='userid' size='30' readonly disabled="true" />
							<input type='hidden' id='lineid' />
							<input type='hidden' id='narration' />
			...
			<div style='border:5px solid #ddd;color:#000000;'>
				<div id="searchdiv">
					...
					<input type="button" style="display:inline" value=" Recalculate Balances " onclick="calculateBalances()" />
					<div id="openbalances" style="display:inline; font-weight:bold; color:blue;"></div>
				</div>
				<div id="listwithdrawals" style="overflow:auto; height: 240px"></div>
			</div>
			<div id="mypic"></div>
			</div>
		</div>
