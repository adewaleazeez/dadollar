        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#transactionlist").dialog({
                    autoOpen: true,
                    position:'center',
                    title: 'Withdrawal Transactions List',
                    height: 500,
                    width: 1100,
                    modal: false,
                    buttons: {
...
//									document.getElementById("balance_aid"+id2[1]).value="";
			...
			createCookie('currentform', 'withdrawal', false);
        </script>
    </head>
    <body>
			...
			<div style='border:5px solid #ddd;color:#000000;'>
				<table style='font-size:14px;'>
					<tr>
						...
						<td>
							<input type="hidden" id="lineno" value="WT" />
					...
					<tr>
						<td colspan="6">
							<div id="translist" style="width:1000px; height:310px; overflow:auto;"></div>
						</td>
					</tr>
				</table>
			</div>
			...
			<div id="transtotal">
				<table style='font-size:14px;'>
					<tr>
						<td width='5.2%'>&nbsp;</td>
						<td width='10%'>
							<b>Total Withdrawals:</b>&nbsp;<input type="text" id="totalamount" size="10" disabled style='text-align:right;' />
						</td>
					</tr>
				</table>
			</div>
...
<script type="text/javascript">
	...
	setTimeout(function () { document.getElementById("transdate").focus(); }, 1000);
</script>